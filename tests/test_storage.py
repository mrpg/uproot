...
def test_str():
    t.materialize(pid).s = "hello world"
...
def test_tuple():
    t.materialize(pid).t = (1, 2, "three", 4.0)
...
def test_bytes():
    t.materialize(pid).b = b"binary data"
...
def test_bool():
    t.materialize(pid).bool_true = True
    t.materialize(pid).bool_false = False
...
def test_decimal():
    t.materialize(pid).d = Decimal("123.456789")
...
def test_frozenset():
    t.materialize(pid).fs = frozenset([1, 2, 3, "a", "b"])
...
def test_player_identifier():
    t.materialize(pid).pi = t.PlayerIdentifier("session1", "user1")
...
def test_session_identifier():
    t.materialize(pid).si = t.SessionIdentifier("session1")
...
def test_group_identifier():
    t.materialize(pid).gi = t.GroupIdentifier("session1", "group1")
...
def test_model_identifier():
    t.materialize(pid).mi = t.ModelIdentifier("session1", "model1")
...
def test_uuid_v1():
    ...
    original_uuid = uuid1()
    t.materialize(pid).uuid_v1 = original_uuid
...
def test_uuid_v3():
    ...
    t.materialize(pid).uuid_v3 = original_uuid
...
def test_uuid_v4():
    ...
    original_uuid = uuid4()
    t.materialize(pid).uuid_v4 = original_uuid
...
def test_uuid_v5():
    ...
    t.materialize(pid).uuid_v5 = original_uuid
...
def test_uuid_from_string():
    ...
    t.materialize(pid).uuid_from_str = original_uuid
...
def test_uuid_from_bytes():
    ...
    t.materialize(pid).uuid_from_bytes = original_uuid
...
def test_uuid_from_hex():
    ...
    t.materialize(pid).uuid_from_hex = original_uuid
...
def test_uuid_from_int():
    ...
    t.materialize(pid).uuid_from_int = original_uuid
...
def test_uuid_nil():
    ...
    t.materialize(pid).uuid_nil = original_uuid
...
def test_uuid_variant_preservation():
    ...
    for i, original_uuid in enumerate(variants_to_test):
        ...
        setattr(t.materialize(pid), attr_name, original_uuid)
