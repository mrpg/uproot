...
def test_comparison_with_nested_fields():
    ...
    comp: Comparison = _.address.city == "Springfield"
    assert comp(person) is True
...
def test_complex_nested_structure():
    ...
    comp: Comparison = _.ceo.address.street == "123 Main St"
