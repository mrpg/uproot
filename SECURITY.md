...
The public key is available from [here](https://max.pm/1636BA9B.asc). Consider reviewing Max Grossmann’s [security page](https://max.pm/security/). The `security` submodule in here contains further information.
