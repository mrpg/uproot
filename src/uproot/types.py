...
AdminType: TypeAlias = Annotated["Storage", "Admin"]
GroupType: TypeAlias = Annotated["Storage", "Group"]
ModelType: TypeAlias = Annotated["Storage", "Model"]
PlayerType: TypeAlias = Annotated["Storage", "Player"]
SessionType: TypeAlias = Annotated["Storage", "Session"]
